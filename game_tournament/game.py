...
def a_tournament():
    ...
    players_mex = ['Chicharito','Piojo','Guardado','Hector Moreno','Rafa Marquez','Salcido','Vela','Dos Santos','Herrera','Layun','Corona']
    players_arg = ['Messi','Di Maria','Aguero','Higuain','Mascherano','Biglia','Dybala','Paredes','Tagliafico','Otamendi','Zabaleta']
    players_peru = ['Guerrero','Carrillo','Flores','Cueva','Yotun','Tapia','Advincula','Trauco','Araujo','Garcia','Gallese']
    players_france = ['Mbappe','Griezmann','Pogba','Kante','Varane','Lloris','Hernandez','Pavard','Matuidi','Giroud','Dembélé']
    players_spain = ['Ramos','Iniesta','Xavi','Pique','Busquets','Alba','Isco','Silva','Morata','Asensio','De Gea']
    players_brazil = ['Neymar','Coutinho','Firmino','Casemiro','Alisson','Thiago Silva','Marquinhos','Alex Sandro','Danilo','Willian','Gabriel Jesus']
    players_italia = ['Buffon','Chiellini','Bonucci','Donnarumma','Insigne','Bernardeschi','Jorginho','Verratti','Belotti','Immobile','Chiesa']
    players_japan = ['Kagawa','Honda','Okazaki','Inui','Yoshida','Hasebe','Kawashima','Nagatomo','Sakai','Shibasaki','Muto']
    sport = Sport("Futbol", 11, "FIFA")
    team_mex = Team("Mexico", sport)
    team_arg = Team("Argentina", sport)
